 ...
 <!--fim Nav bar---->
    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="card custom-margin custom-padding">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-justify">Domine a arte do Front-End! Inscreva-se agora para o curso
                            ...
                            <a href="./formEscolha.jsp" class="btn btn-warning">Inscreva-se</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card custom-margin custom-padding">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-justify">Construa a base do digital! Inscreva-se no curso Back-End e
                            ...
                            funcionalidade.</p>
                        <a href="./formEsolha.jsp" class="btn btn-warning">Inscreva-se</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="card custom-margin custom-padding">
                    <img src="./img/unix1.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card custom-margin custom-padding">
                    <img src="./img/segurInfo.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        ...
                        <p class="card-text">Proteja o mundo digital! Inscreva-se no curso de Segurança da Informação,
                            aprenda a defender sistemas contra ameaças cibernéticas. Torne-se o guardião da era digital de uma empresa!
                        </p>
             ...
             <div class="col-md-4">
                <div class="card custom-margin custom-padding">
                    <img src="./img/cloud2.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
