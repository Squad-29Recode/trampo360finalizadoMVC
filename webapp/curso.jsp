		...
		<header class="tag">
			<h1 class="container">Curso</h1>
				...
				<table class="table table-responsive table-hover">
					...
					<jstl:forEach items="${listaEscolha}" var="c">
						<tr>
							...
							<td>
								...
								<div class="d-flex">
										<a href="escolha-edit?id=${c.id_Curso}" class="btn btn-primary mb-1" >Editar</a>
											
										<a href="escolha-delete?id=${c.id_Curso}" onclick="return confirm('Deseja excluir ${c.data_Escolha}?')" class="btn btn-danger mb-1">Excluir</a>
