...
String route = request.getServletPath();
  ...
  response.sendRedirect("/index.html");
    ...
    protected void aquisicao(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	RequestDispatcher rd=request.getRequestDispatcher("view/evento/aquisicao.jsp");
        ...
        protected void read(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            RequestDispatcher rd=request.getRequestDispatcher("views/evento/aquisicao.jsp");
            rd.forward(request, response);
            }
        ...
        protected void edit(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    		...
    		RequestDispatcher rd = request.getRequestDispatcher("views/evento/editAquisicao.jsp");
    		rd.forward(request, response);
