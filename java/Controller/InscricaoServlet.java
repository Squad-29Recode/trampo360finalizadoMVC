...
String route = request.getServletPath();
  ...
  response.sendRedirect("/index.html");
    ...
    protected void aquisicao(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	RequestDispatcher rd=request.getRequestDispatcher("view/vaga/inscricao.jsp");
        ...
        protected void edit(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    		...
    		RequestDispatcher rd = request.getRequestDispatcher("view/vaga/editInscricao.jsp");
    		rd.forward(request, response);
