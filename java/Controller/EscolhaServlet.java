...
String route = request.getServletPath();
  ...
  response.sendRedirect("/index.html");
    ...
    protected void escolha(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	RequestDispatcher rd=request.getRequestDispatcher("./formEscolha.jsp");
        ...
        protected void save(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            int id_Escolha = Integer.parseInt(request.getParameter("escolha"));
            escolha.setAluno(adao.readById(idaluno));  
            escolha.setCurso(cdao.readById(id_Escolha));              
